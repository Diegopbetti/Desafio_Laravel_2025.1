<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 hm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">                
                <!-- Navigation Links -->
                <div class="hidden space-x-8 hm:-my-px hm:ms-10 hm:flex items-center">
            ...
            <!-- Settings Dropdown -->
            <div class="hidden hm:flex hm:items-center hm:ms-6">
            ...
            <!-- Hamburger -->
            <div class="-me-2 flex items-center hm:hidden">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden hm:hidden">
