...
<body>
    <div id="edit" class="fixed inset-0 items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white p-6 rounded-lg w-1/3 shadow-lg">
            ...
            <form action="@csrf">
                ...
                <input type="number" placeholder="Balance" class="border p-2 w-full mb-2 rounded" required>
                ...
                <div class="flex justify-end mt-4">
                    ...
                    <button type="button" onclick="fecharModal('edit')" class="ml-2 text-gray-600 hover:underline">
                        Fechar
                    </button>
                </div>
            </form>
